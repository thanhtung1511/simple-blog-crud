...
@section('title', __('labels.backend.auth.users.management') . ' | ' . __('labels.backend.auth.users.edit'))
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('labels.backend.auth.users.edit')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
