...
@section('title', __('labels.frontend.blog.posts.management') . ' | ' . __('labels.frontend.blog.posts.create'))

@section('content')
    {{ html()->form('POST', route('frontend.blog.post.store'))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
